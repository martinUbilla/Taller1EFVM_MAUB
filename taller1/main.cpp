    ...
    switch (opcion)
    {
        case 1:{
            ...
            if(tipo=='R'){
                ...
                sistemaBiblioteca->agregarMaterialRevista(nombre,autor,isbn,numeroEdicion,mesPublicacion, "S/U");
            }
            else if (tipo=='L'){
                ...
                getline(cin,resumen);
                sistemaBiblioteca->agregarMaterialLibro(nombre,autor,isbn,fechaPublicacion,resumen,"S/U");
            }
        ...
        case 8:{
            string id,isbn, texto;
            bool devolucion;
            devolucion = sistemaBiblioteca->materialesParaDevolver();
            if(devolucion != true){
                cout<<"**********************************"<<endl;
                cout<<"* No hay materiales disponibles! *"<<endl;
                cout<<"**********************************"<<endl;
